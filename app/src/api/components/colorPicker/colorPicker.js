import { addStyleIfNotExists, debounce } from "../../../js/Util.js";
...
class ColorPicker extends HTMLElement {
    constructor() {
        ...
        subCont.className = 'color-picker-container__inner';
...
function ColorPickerControl(cfg) {
    ...
    this.update = function (trigger_change_event = true) {
        ...
        self.container.children[0].style.backgroundColor = `rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]})`;
        self.container.children[1].style.border = `1px solid rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]})`;
        //..
