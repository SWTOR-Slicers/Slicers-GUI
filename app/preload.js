...
contextBridge.exposeInMainWorld(
  "api", {
      send: (channel, data) => {
          let validChannels = ["logToPopped", "logToFile", "showDialog", "runExec", "updateJSON", "getConfigJSON", "initLogger", "sendLoggerData", "closeLoggerWindow", "logToPopped", "updateExtractionPreset"];
